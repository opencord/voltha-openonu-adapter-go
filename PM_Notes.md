...
`Note` : The values collected for the metrics are as is from the OMCI messages, meaning the adapter any sort of conversion. Refer OMCI spec (G.988 v 11/2017 edition) to get more details of the units of the collected metrics.
