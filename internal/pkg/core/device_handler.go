...
func (dh *deviceHandler) addOnuDeviceEntry(ctx context.Context) error {
	...
	if deviceEntry == nil {
		...
		deviceEntry = mib.NewOnuDeviceEntry(ctx, dh.coreProxy, dh.adapterProxy, dh, dh.pOpenOnuAc)
...
func (dh *deviceHandler) addFlowItemToUniPort(ctx context.Context, apFlowItem *ofp.OfpFlowStats, apUniPort *cmn.OnuUniPort,
...
func (dh *deviceHandler) removeFlowItemFromUniPort(ctx context.Context, apFlowItem *ofp.OfpFlowStats, apUniPort *cmn.OnuUniPort) error {
...
func (dh *deviceHandler) deviceReasonUpdate(ctx context.Context, deviceReason uint8, notifyCore bool) error {
	...
	if notifyCore {
		...
		if err := dh.coreProxy.DeviceReasonUpdate(log.WithSpanFromContext(context.TODO(), ctx), dh.DeviceID, cmn.DeviceReasonMap[deviceReason]); err != nil {
...
// GetAdapterTopic - TODO: add comment
func (dh *deviceHandler) GetAdapterTopic() string {
	return dh.pOpenOnuAc.config.Topic
}
...
// GetCoreProxy - TODO: add comment
func (dh *deviceHandler) GetCoreProxy() adapterif.CoreProxy {
	return dh.coreProxy
}
