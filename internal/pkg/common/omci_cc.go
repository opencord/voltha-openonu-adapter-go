...
//The appropriate lock should be taken prior to using this functio
...
func (oo *OmciCC) PrepareOnuSectionsOfWindow(ctx context.Context, rxChan chan Message,
	aImageMeID uint16, aAckRequest uint8, aDownloadSectionNo uint8, aSection []byte, aPrint bool,
...
func (oo *OmciCC) SendOnuSwSectionsWindowWithRxSupervision(ctx context.Context,
	aOmciTxRequest OmciTransferStructure, aTimeout int, retry int) {
