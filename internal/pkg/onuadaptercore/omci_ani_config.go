...
func (oFsm *uniPonAniConfigFsm) prepareAndEnterConfigState(ctx context.Context, aPAFsm *AdapterFsm) {
	if aPAFsm != nil && aPAFsm.pFsm != nil {
		...
		//oFsm.mapperSP0ID = ieeMaperServiceProfileBaseEID + uint16(oFsm.pOnuUniPort.macBpNo) + uint16(oFsm.techProfileID)
		//oFsm.macBPCD0ID = macBridgePortAniBaseEID + uint16(oFsm.pOnuUniPort.entityID) + uint16(oFsm.techProfileID)
		var err error
