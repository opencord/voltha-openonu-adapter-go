...
func (dm *adapterDownloadManager) downloadFile(ctx context.Context, aURLName string, aFilePath string, aFileName string) error {
	...
	go dm.requestDownload(ctx, urlBase, respExist, aFilePath, aFileName)
	return nil
}

func (dm *adapterDownloadManager) requestDownload(ctx context.Context, urlBase *url.URL, respExist *http.Response, aFilePath, aFileName string) {
