...
func (oo *omciCC) sendCreateTD(ctx context.Context, timeout int, highPrio bool, rxChan chan Message, params ...me.ParamData) *me.ManagedEntity{
	tid := oo.getNextTid(highPrio)
...
func (oo *omciCC) sendSetTD(ctx context.Context, timeout int, highPrio bool, rxChan chan Message, params ...me.ParamData) *me.ManagedEntity {
	tid := oo.getNextTid(highPrio)
...
func (oo *omciCC) sendDeleteTD(ctx context.Context, timeout int, highPrio bool, rxChan chan Message, params ...me.ParamData) *me.ManagedEntity {
	tid := oo.getNextTid(highPrio)
