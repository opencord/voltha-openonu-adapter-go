...
const (
	...
	OpticalPowerMetricGroupCollectionFrequency = 5 * 60 // unit in seconds. This setting cannot be changed from voltha NBI PmConfig configuration
)
...
const (
	...
	UniStatusMetricGroupCollectionFrequency = 5 * 60 // unit in seconds. This setting cannot be changed from voltha NBI PmConfig configuration
)
