			...
			for k := range OpticalPowerGroupMetrics {
				...
				case "transmit_power_dBm":
					if val, ok := meAttributes["TransmitOpticalLevel"]; ok && val != nil {
						opticalMetrics[k] = float32(mm.twosComplementToSignedUint16(val.(uint16))) / 500 // convert to dBm
					}
...
func (mm *onuMetricsManager) twosComplementToSignedUint16(val uint16) int16 {
...
func (mm *onuMetricsManager) twosComplementToSignedUint32(val uint32) int32 {
...
func (mm *onuMetricsManager) twosComplementToSignedUint64(val uint64) int64 {
