...
type unknownMeDbMap map[string]map[me.ClassID]map[uint16]unknownMeAttribs
...
func (OnuDeviceDB *OnuDeviceDB) PutUnknownMe(ctx context.Context, aMeName string, aMeClassID me.ClassID, aMeEntityID uint16,
