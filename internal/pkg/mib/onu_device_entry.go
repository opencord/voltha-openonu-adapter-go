...
func NewOnuDeviceEntry(ctx context.Context, cp adapterif.CoreProxy, ap adapterif.AdapterProxy, dh cmn.IdeviceHandler,
	...
	onuDeviceEntry.coreProxy = cp
	onuDeviceEntry.adapterProxy = ap
...
func (oo *OnuDeviceEntry) Start(ctx context.Context) error {
	...
	if oo.PDevOmciCC == nil {
		oo.PDevOmciCC = cmn.NewOmciCC(ctx, oo.deviceID, oo.baseDeviceHandler, oo, oo.baseDeviceHandler.GetOnuAlarmManager(), oo.coreProxy, oo.adapterProxy)
		if oo.PDevOmciCC == nil {
