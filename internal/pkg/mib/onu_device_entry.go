...
// GetMibDownloadSuccess returns the MIB download success flag
func (oo *OnuDeviceEntry) GetMibDownloadSuccess() bool {
...
// GetRaiseMibUploadFailureEvent returns the MIB upload failure event flag
func (oo *OnuDeviceEntry) GetRaiseMibUploadFailureEvent() bool {
