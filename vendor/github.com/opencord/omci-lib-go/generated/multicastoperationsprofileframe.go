...
// TODO this is copied for now from a local file sent by chip, needs upstreaming and libary version modification
...
func init(){
	multicastoperationsprofileME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			6: Uint32Field("USIgmpRate", UnsignedIntegerAttributeType, 0x0400, 0, mapset.NewSetWith(Read), false, true, false, 6),
			7: MultiByteField("DynamicAccessControlListTable", TableAttributeType, 0x0200, 24, toOctets("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA="), mapset.NewSetWith(Read, Write), false, false, false, 7),
			8: MultiByteField("StaticAccessControlListTable", TableAttributeType, 0x0100, 24, toOctets("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA="), mapset.NewSetWith(Read, Write), false, true, false, 8),
			9: MultiByteField("LostGroupsListTable", TableAttributeType, 0x0080, 10, toOctets("AAAAAAAAAAAAAA=="), mapset.NewSetWith(Read), false, true, false, 9),
